...
export function PlaylistCarouselSection({ playlists, loading, error, onOpenPlaylist }: Props) {
  ...
  return (
    <section className="shelf" aria-label="Мои плейлисты">
      <div className="section-heading">
        <div><div className="eyebrow">SOUNDCLOUD</div><h2>Мои плейлисты <span className="track-count">{playlists.length}</span></h2></div>
